<nav class="sidebar vertical-scroll  ps-container ps-theme-default ps-active-y">
    <div class="logo d-flex justify-content-between">
        <a href="index-2.html"><img src={{ asset('themes/admin/img/logo.png') }} alt></a>
    ...
    <ul id="sidebar_menu">
        ...
        <li class>
            ...
            <ul>
                ...
                <li><a href="mail_box.html">Thêm sản phẩm</a></li>
            </ul>
        </li>
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src={{ asset('themes/admin/img/menu-icon/3.svg') }} alt>
                </div>
                <span>Danh mục</span>
            </a>
            <ul>
                <li><a href="{{ route('admin.catalogues.index') }}">Danh sách</a></li>
                <li><a href="{{ route('admin.catalogues.create') }}">Thêm danh mục</a></li>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src={{ asset('themes/admin/img/menu-icon/4.svg') }} alt>
                </div>
                <span>forms</span>
            </a>
            <ul>
        ...
        <li class>
            <a href="Board.html" aria-expanded="false">
                <div class="icon_menu">
                    <img src={{ asset('themes/admin/img/menu-icon/5.svg') }} alt>
                </div>
                <span>Board</span>
            </a>
        </li>
        <li class>
            <a href="invoice.html" aria-expanded="false">
                <div class="icon_menu">
                    <img src={{ asset('themes/admin/img/menu-icon/6.svg') }} alt>
                </div>
                <span>Invoice</span>
            </a>
        </li>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src={{ asset('themes/admin/img/menu-icon/11.svg') }} alt>
                </div>
                <span>Table</span>
            </a>
            <ul>
        ...
        <li class>
            <a class="has-arrow" href="#" aria-expanded="false">
                <div class="icon_menu">
                    <img src={{ asset('themes/admin/img/menu-icon/12.svg') }} alt>
                </div>
                <span>Cards</span>
            </a>
            <ul>
